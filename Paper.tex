...
\label{sec:tests}
 ...
 For every instance, we ran the three formulations with a $1$h time limit each. The three formulations are the compact formulation, the extended formulation with exact pricing, and the extended formulation with heuristic pricing.
