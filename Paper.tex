...
This heuristic also assumes the concavity of function $f$, as otherwise ?????. However, we were unable to create a realistic example where this would not be the case, in the context of production-maintenance scheduling.
...
MAYBE I'LL REMOVE THIS SUBSECTION
